...
1. **Analyze domain** â€” Understand business requirements, data models, and client needs
2. **Model resources** â€” Identify resources, relationships, and operations; sketch entity diagram before writing any spec
3. **Design endpoints** â€” Define URI patterns, HTTP methods, request/response schemas
4. **Specify contract** â€” Create OpenAPI 3.1 spec; validate before proceeding: `npx @redocly/cli lint openapi.yaml`
5. **Mock and verify** â€” Spin up a mock server to test contracts: `npx @stoplight/prism-cli mock openapi.yaml`
6. **Plan evolution** â€” Design versioning, deprecation, and backward-compatibility strategy
...
- Use consistent naming conventions (snake_case or camelCase â€” pick one, apply everywhere)
...
- `type` must be a stable, documented URI â€” never a generic string.
